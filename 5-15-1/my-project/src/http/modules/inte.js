...
//编辑出库单
export const updateoutProduct = data => {
    return axios({
        url: '//http://localhost:8081/ExitStorageApi/update',
        method: 'put',
        data
    })
}
...
export const getProductInfo = () => {
    return axios({
        url: 'http://localhost:8081/ProductInformationApi/findAllInformation',
        method: 'get'
    })
}
//删除库存账
export const delProductInfo = data => {
    return axios({
        url: 'http://localhost:8081/ProductInformationApi/delete',
        method: 'post',
        data
    })
}
...
//删除员工销售
export const delProductSale = data => {
    return axios({
        url: 'http://localhost:8081/ProductSalesApi/delete',
        method: 'post',
        data
    })
}
...
export const addProductSale = data => {
    return axios({
        url: 'http://localhost:8081/ProductSalesApi/add',
        method: 'post',
        data
    })
}
//编辑员工销售
export const updateProductSale = data => {
    return axios({
        url: 'http://localhost:8081/ProductSalesApi/update',
        method: 'put',
        data
    })
}
...
//编辑公司销售
export const updateSell = data => {
    return axios({
        url: 'http://localhost:8081/SellApi/update',
        method: 'put',
        data
    })
}
//删除公司销售
export const delSell = data => {
    return axios({
        url: 'http://localhost:8081/SellApi/delete',
        method: 'post',
        data
    })
}